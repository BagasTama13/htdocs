...
<div class="container mt-4" class="p-3 mb-2 bg-transparent text-dark">
    ...
    <fieldset >
        <legend><a href="create.php" class="btn btn-outline-dark btn-dark mb-2 mt-5 text-light"><i class="bi bi-person-plus"></i>Buat Survei Baru</a></legend>
    <table class="table table-striped table-bordered border-dark table-hover">
        <thead class="table-dark">
            <tr class="container col-md-12">
                ...
                <th class="container col-md-4 text-center"scope="col">Judul</th>
