...
<div class="container mt-4">
    <fieldset class=" container border-1-dark">
        <legend class="text-center mt-4">TAMBAHKAN SURVEI</legend>
    <form action="" method="post" enctype="multipart/form-data">
        <!-- Your existing form code here -->
        <div class="form-group ">
            <label for="icon" class="for-label mb-2 mt-2">Icon</label>
            <input type="file" name="icon" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="judul" class="for-label mb-2 mt-2">Judul</label>
            <input type="text" name="judul" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="link" class="form-label mb-2 mt-2">Link</label>
