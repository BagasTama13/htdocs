...
<div class="container text-left mt-2">
    <a href="home.php" class="btn btn-primary mt-5"> Back </a>
</div>
        ...
        <div class="row">
            <div class="col-md-2 offset-md-1 mt-4">
                ...
                <div class="form-group mt-4">
                    <img src="images/<?php echo $row['icon']; ?>" width="170" height="200" alt="Current Icon">
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content text-center">
                <div class="modal-body">
                    <h1 class="mt-4"><i class="bi bi-check-circle text-success fa-10x"></i><i class="bi bi-check-circle text-success fa-10x"></i><i class="bi bi-check-circle text-success fa-10x"></i><i class="bi bi-check-circle text-success fa-10x"></i></h1>
